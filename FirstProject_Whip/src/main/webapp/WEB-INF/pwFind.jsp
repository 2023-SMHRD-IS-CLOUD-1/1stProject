			...
			<div
				...
				<div class="flex-fill">
					<ul
						...
						<li class="nav-item"><a class="nav-link" href="Gocontact.do">고객센터</a>
						</li>
					</ul>
				</div>
		...
		<section class="form-search">
			...
			<div class="find-id">
				<label>아이디</label> <input type="text" id="user_id"
					placeholder="가입한 아이디를 입력해주세요"> <br>
			</div>
			<div class="find-jumin">
				<label>주민등록번호</label> <input type="text" id="user_jumin"
					placeholder="주민번호를 입력해주세요 000000-0000000">
			</div>
