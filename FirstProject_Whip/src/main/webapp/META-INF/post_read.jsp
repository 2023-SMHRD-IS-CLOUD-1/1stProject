...
<body>
	...
	<div class="container py-5" id="postWriteBoard">
		<div id="postReadLayout">
			...
			<div id="postReadNav">
				<span>메창</span> <span>23.11.24</span> <span>조회 113</span> <span>추천
					1</span> <span>댓글 0</span>
				<button>목록</button>
			</div>
			<hr>
			<div id="postReadSect1">
				<span>안녕하세요. 이번에 새로 메이플 시작한 뉴비인데 직업 비숍으로 생각하고 있습니다. 무자본이고 하루에
					2~3시간 정도 접속하는데 4차전직까지 시간 얼마나 걸릴까요??</span>
				<div>1</div>
				<div>1</div>
				<div>1</div>
				<div>1</div>
			...
			<div id="postReadSect4">
				<table>
					...
					<tr>
						...
						<td class="sect4TableContent">으아아아
							<div>1</div>
							<div>1</div>
							<div>1</div>
							<div>1</div>
						...
						<td class="sect4Tablefavor"><span>1</span>
							<button>추천</button></td>
					</tr>
					<tr>
						...
						<td class="sect4Tablefavor"><span>13</span>
							<button>추천</button></td>
					</tr>
					<tr>
						...
						<td class="sect4TableContent">내용</td>
						<td class="sect4TableDate">일자</td>
						<td class="sect4Tablefavor"><span>2</span>
							<button>추천</button></td>
					</tr>
				</table>
			</div>
